...
<?php
	...
	// Create the DiscordClient and let the user know how to invite the bot
        ...
        $lastMessageTimestamp = $client->channel->getChannelMessages(['channel.id' => 758584661503901697, 'channel.before' => $lastRun])[0]->timestamp->format('Y-m-d H:i:s.u');
        var_dump($lastMessageTimestamp);
